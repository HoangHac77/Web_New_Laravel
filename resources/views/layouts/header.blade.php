        ...
        <div class="container">
            <div class="row">
                <div class="col-md-3 col-sm-12">
                    <div class="brand">
                        <a href="index.html">
                            <img src="{{ asset('client/images/logo.png') }}" alt="Magz Logo">
                        </a>
                    </div>
                </div>
                ...
                <div class="col-md-3 col-sm-12 text-right">
                    <ul class="nav-icons">
                        ...
                        @guest
                            @if (Route::has('login'))
                                <li class="nav-item">
                                    <a href="{{ route('login') }}"><i class="ion-person-add"></i>
                                        <div>{{ __('Login') }}</div>
                                    </a>
                                </li>
                            @endif
                        ...
                        @else
                            <li class="nav-item dropdown">
                                <a id="navbarDropdown" class="nav-link dropdown-toggle" href="#" role="button"
                                    ...
                                    <div style="padding-right: 5px">Welcome, </div>
                                    <div style="padding-right: 5px">{{ Auth::user()->name_user }}</div>
                                ...
                                {{-- <div style="margin-top: 20px" class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        ...
                                        <ul class="vertical-menu">
                                            <li><a href="#"><i class="ion-ios-circle-outline"></i> Mega menu
                                                    is a new feature</a></li>
                                            <li><a href="#"><i class="ion-ios-circle-outline"></i> This is
                                                    an example</a></li>
                                            <li><a href="#"><i class="ion-ios-circle-outline"></i> For a
                                                    submenu item</a></li>
                                            <li><a href="#"><i class="ion-ios-circle-outline"></i> You can
                                                    add</a></li>
                                        ...
                                        <div class="row">
                                            <article class="article col-md-4 mini">
                                                <div class="inner">
                                                    <figure>
                                                        <a href="single.html">
                                                            <img src="{{ asset('client/images/news/img10.jpg') }}"
                                                                alt="Sample Article">
                                                        </a>
                                                    </figure>
                                                    <div class="padding">
                                                        ...
                                                        <h2><a href="single.html">Duis aute irure dolor in
                                                                reprehenderit in voluptate</a></h2>
                                                    </div>
                                                </div>
                                            </article>
                                            <article class="article col-md-4 mini">
                                                <div class="inner">
                                                    <figure>
                                                        <a href="single.html">
                                                            <img src="{{ asset('client/images/news/img11.jpg') }}"
                                                                alt="Sample Article">
                                                        </a>
                                                    </figure>
                                                    <div class="padding">
                                            ...
                                            <article class="article col-md-4 mini">
                                                <div class="inner">
                                                    <figure>
                                                        <a href="single.html">
                                                            <img src="{{ asset('client/images/news/img14.jpg') }}"
                                                                alt="Sample Article">
                                                        </a>
                                                    </figure>
                                                    <div class="padding">
