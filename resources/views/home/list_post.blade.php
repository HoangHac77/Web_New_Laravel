                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <p class="page-subtitle">
                                Showing all posts with category
                                <i>Computer</i>
                            </p>
                        </div>
                    </div>
                        ...
                        <article class="col-md-12 article-list">
                            <div class="inner">
                                ...
                                <div class="details">
                                    ...
                                    <h1>
                                        <a href="single.html">Lorem Ipsum Dolor Sit
                        ...
                        <div class="aside-body">
                            ...
                            <article class="article-mini">
                                <div class="inner">
                                    ...
                                    <div class="padding">
                                        <h1>
                                            <a href="single.html">Fusce ullamcorper elit at
                                                felis cursus suscipit</a>
                                        </h1>
                                        <div class="detail">
                                            <div class="category">
                    ...
                    <aside>
                        <div class="aside-body">
                            <form class="newsletter">
                                ...
                                <p>
                                    By subscribing you will receive new
                                    articles in your email.
                                </p>
                            </form>
                        </div>
                    </aside>
