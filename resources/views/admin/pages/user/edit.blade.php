...
@section('content')
    <main>
        ...
        <form action="/admin/user/{{ $users->id }}" method="POST" enctype="multipart/form-data">
            <!-- Main page content-->
            @csrf
            @method('PUT')
                            ...
                            <div class="card-body">
                                ...
                                <div class="row gx-3 mb-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input class="form-control @error('name_user') is-invalid @enderror"
                                            id="inputUserName" type="text" placeholder="Enter User Name" name="name_user"
                                            value="{{ $users->name_user }}" />
                                        @error('name_user')
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <select style="padding-top: 18px"
                                            class="form-select @error('gender') is-invalid @enderror" id="form-gender"
                                            name="gender" aria-label="Default select example">
                                            {{-- <option value="" selected>Select Gender</option> --}}
                                            <option value="Male" @if ($users->gender == 'male') selected @endif>Male
                                            </option>
                                            <option value="Female" @if ($users->gender == 'female') selected @endif>Female
                                            </option>
                                        </select>
                                        @error('gender')
                                            <label class="small mb-2 alert alert-danger"
                                ...
                                <div class="row gx-3 mb-3">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <select style="padding-top: 18px"
                                            class="form-select  @error('role') is-invalid @enderror" id="form-role"
                                            name="role" aria-label="Default select example">
                                            <option value="" >Select Role </option>
                                            <option value="0" @if ($users->role == 'user') selected @endif>User
                                            </option>
                                            <option value="1" @if ($users->role == 'author') selected @endif>Author</option>
                                            <option value="2" @if ($users->role == 'admin') selected @endif>Admin</option>
                                        </select>
                                ...
                                <div class="row gx-3 mb-3">
                                    ...
                                    <div class="col-md-3 mb-3">
                                        ...
                                        <input class="form-control @error('img_profile') is-invalid @enderror"
                                            type="file" id="formFile" name="img_profile">
                                        @error('img_profile')
                                            <label class="small mb-2 alert alert-danger"
                                                style="background-color: transparent; border-color: transparent; padding-bottom: 0;
                                padding-left: 0;">{{ $message }}</label>
